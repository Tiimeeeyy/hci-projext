...
export default function LibraryPage() {
    ...
    return (<div className="min-h-screen p-4">
        ...
        <div className="max-w-4xl mx-auto">
            ...
            {isEditMode ? (// Edit Mode - Selection with checkboxes
                <>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-4">
                        {editModeLoading && filteredGames.length === 0 ? (
                            ...
                            <div className="overflow-y-auto max-h-[70vh]">
                                {filteredGames.length > 0 ? (filteredGames.map((game) => (<div
                                    key={game.id}
                                    className={`flex items-center p-3 border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 ${libraryGames.includes(game.id) ? 'bg-blue-50 dark:bg-blue-900/20' : ''}`}
                                >
                                    <input
                                        type="checkbox"
                ...
                <>
                    {loading ? (<div className="flex justify-center items-center h-64">
                                ...
                                <div className="p-4">
                                    ...
                                    {game.genres && game.genres.length > 0 && (
                                        <div className="flex flex-wrap gap-1 mb-2">
                                            {game.genres.slice(0, 3).map(genre => (<span key={genre}
                                                                                         className="px-1.5 py-0.5 bg-gray-100 dark:bg-gray-700 text-xs rounded-full">
                              {genre}
                            </span>))}
                                        </div>)}
                        ...
                        </div>) : (<div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 text-center">
